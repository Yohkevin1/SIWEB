         ...
         <div class="container-fluid px-4">
             ...
             <div class="card mb-4">
                 <div class="card-header">
                     ...
                     Tambah <?= $validation->getError('judul') ?>
                 </div>
                 <div class="card-body">
                     <!-- Form data -->
                     <form action="/komik-create" method="post" enctype="multipart/form-data">
                         ...
                         <div class="mb-3 row">
                             ...
                             <div class="col-sm-5">
                                 <input type="text" class="form-control <?= $validation->hasError('tahun_rilis') ? 'is-invalid' : '' ?>" id="tahun_rilis" name="tahun_rilis" value="<?= old('tahun_rilis') ?>">
                                 <div id="validationServer03Feedback" class="invalid-feedback">
